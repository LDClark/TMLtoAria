...
namespace TMLtoAria
{
    public class MainViewModel : ObservableObject
    {
        ...
        public MainViewModel(User user, ExternalPlanSetup plan, DocSettings docSet)
        {
            ...
            Plan = new PlanViewModel
            {
                ...
                PatientBirthdate = patient.DateOfBirth.Value.Date.ToShortDateString(),
                PatientSex = patient.Sex,
                PatientPrimaryOncologist = patient.PrimaryOncologistId,           
                PlanId = plan.Id,
                PlanName = plan.Name,
                PlanCreation = (DateTime)plan.CreationDateTime,
                PlanIntent = plan.PlanIntent,
                Beams = plan.Beams,
                PlanStructureSetId = plan.StructureSet.Id,
                PlanImageId = plan.StructureSet.Image.Id,
                ImageUserOrigin = plan.StructureSet.Image.UserOrigin.ToString(),
                TreatmentOrientation = plan.TreatmentOrientation.ToString(),
                CourseId = plan.Course.Id,
                CourseIntent = course.Intent,
                TargetVolumeId = plan.TargetVolumeID,
                PrimaryReferencePointId = plan.PrimaryReferencePoint.Id
            };
